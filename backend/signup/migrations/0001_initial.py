    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vegetarian_ingredient', models.ManyToManyField(to='signup.ingredient')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('religion', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='signup.religion')),
                ('user_allergy', models.ManyToManyField(blank=True, to='signup.allergy')),
                ('user_vegetarian', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='signup.vegetarian')),
            ],
        ),
        migrations.CreateModel(
            name='Ordered_Item',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('menu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='signup.menu')),
                ('option', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='signup.option')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='signup.order')),
            ],
        ),
        migrations.AddField(
            model_name='order',
            name='payment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='signup.payment'),
        ),
        migrations.AddField(
            model_name='order',
            name='user',
        ...
        migrations.AddField(
            model_name='option',
            name='optioncategory',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='signup.optioncategory'),
        ),
        migrations.AddField(
            model_name='menu',
            name='menu_option',
        ...
        migrations.AddField(
            model_name='menu',
            name='menucategory',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='signup.menucategory'),
        ),
        migrations.AddField(
            model_name='allergy',
